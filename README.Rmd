...
package introduction for some alternatives.
...
taxonomists, please e-mail to raflima@usp.br.
...
We thank Sidnei Souza from speciesLink for his help with the web API. We also
thank the [CNCFlora](http://cncflora.jbrj.gov.br) and the [TreeCo
