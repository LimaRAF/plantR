...
## Details
  ...
  The package plantR was developed to deal with data typically obtained from herbarium collections and it provides tools to perform:
  1) the download of herbarium data for a list of species names or collections codes;
  2) the batch processing of typical herbarium fields (e.g. collector name);
  3) geographical and taxonomic validation of herbarium records. 
