...
__plantR__ is an R package meant to format, standardize and validate the information that comes from different biodiversity databases, such as GBIF, species link,    <!-- ö acrescentar um objetivo mais   --> 

## Público alvo/target users
...
# Workflow overview 
<!-- Estrutura do workflow (módulos, funções, a sequência) --> 

## Dados/dicionário de dados/bases de dados 
 <!-- a fonte criação e formatação de todas as bases de dados deveria estar documentada
