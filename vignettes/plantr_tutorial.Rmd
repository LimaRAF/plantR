...
## Problemática e objetivo do pacote

The information on each specimen is the responsability of the collector, who decides which information is relevant and records the collection locality with the precision available. The traditions regarding information that is recorded have changed with time, for example nowadasys it is a common practice to record coordinates taken with a GPS. 
...
* collectors
  ...
  + changing toponymes (names of localities)
  + human errors
+ collections
...
field editing,
locality formating,
geographic validation and
taxonomical validation.

## Dados/dicionário de dados/bases de dados 

The source data that composes this package <!-- a fonte criação e formatação de todas as bases de dados deveria estar documentada
