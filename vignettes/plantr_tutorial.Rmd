...
Note that the edited version of the localities has some improve regarding the number of localities provided at "stateProvince" level and that some of the localities provided could be retrieved in the default gazetteer. 
...
## Editing original coordinates and defining working coordinates: function `formatCoord()` (TO BE CHECKED)
