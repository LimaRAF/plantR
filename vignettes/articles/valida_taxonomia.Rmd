...
to be correctly spelled and we should use only their currently
...
nomenclature, which becomes quite burdensome as the size of the
dataset increases.

__plantR__ provides tools to format, spell-check and validate taxon
names using different taxonomic backbones. The default backbone used
...
(see the section [Brief code summary] below). But first, we will explain 
in detail each step and function to manage taxonomy within __plantR__.
