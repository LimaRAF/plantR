...
#'
#' @param x a data frame containing the resolution of the original and
#'   the gazetteer locality information.resolution from the gazetteer.
#' @param res.orig character. The name of the column containing the
...
#'
#' @return the data frame \code{x} with a new column 'loc.check' with
#'   the result of the locality validation.
#'
#'
#' @details The function simply compares if the original information
...
#'   __plantR__ is strongly biased towards Latin America, particularly
#'   Brazil.
#'
...
#'   not be seen as problematic, since the __plantR__ gazetteer
